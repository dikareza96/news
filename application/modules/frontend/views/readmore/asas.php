...
<html lang="en">
  <head>
    ...
    <title>Our Courses-Single Course</title>
    ...
    <div class="wm-main-wrapper">
		...
		<header id="wm-header" class="wm-header-one">
            ...
            <div class="wm-main-header">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3"><a href="index.html" class="wm-logo"><img src="images/logo-1.png" alt=""></a></div>
                        <div class="col-md-9">
                            <!--// Navigation \\-->
            ...
            <div class="wm-copyright">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6"> <p>© 2016, All Right Reserved - by <a href="index.html" class="wm-color">WebMarce</a></p> </div>
                    </div>
                </div>
            </div>
            <!--// FooterCopyRight \\-->
