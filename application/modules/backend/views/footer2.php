 ...
 <!-- daterangepicker -->
  ...
  <!-- input mask -->
  <script src="<?php echo base_url(); ?>assets/production/js/input_mask/jquery.inputmask.js"></script>
  <!-- knob -->
  <script src="<?php echo base_url(); ?>assets/production/js/knob/jquery.knob.min.js"></script>
  <!-- range slider -->
  <script src="<?php echo base_url(); ?>assets/production/js/ion_range/ion.rangeSlider.min.js"></script>
  <!-- color picker -->
  <script src="<?php echo base_url(); ?>assets/production/js/colorpicker/bootstrap-colorpicker.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/production/js/colorpicker/docs.js"></script>

  <!-- image cropping -->
  <script src="<?php echo base_url(); ?>assets/production/js/cropping/cropper.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/production/js/cropping/main2.js"></script>
  <!-- pace -->
